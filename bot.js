...
function validatePhoneNumber(text) {
    ...
    if (!/^\d{7,15}(\|\d{1,10})?$/.test(text)) {
        return { 
            valid: false, 
            error: '❌ Invalid format. Use: `2349168095230` or `2348140825959|1234`' 
        };
    }
...
bot.onText(/\/start/, (msg) => {
    ...
    const welcomeMessage = `👋 Hello SAGE-XD  USER
  **Welcome to SAGE-XD  bot**
  ...
  reply_markup: {
    inline_keyboard: [
      [
        { 
          text: '👥 Join Group', 
          url:'https://t.me/+TfvefdkLTt8xZDA0' 
        }
      ],
      [
        { 
          text: '📢 Channel 1', 
          url: 'https://t.me/venomempire_404' 
        },
        { 
          text: '📢 Channel 2', 
          url: 'https://t.me/sharptechn' 
        }
      ],
      [
        { 
          text: '📢 Backup Channel', 
          url: 'https://t.me/empire_xmd_backup' 
        }
      ],
      [
        { 
          text: '💬 WhatsApp', 
          url: 'https://whatsapp.com/channel/0029Vb6Og0a77qVTP5tv5E1f' 
        }
      ]
    ]
  }
...
;
  ...
  reply_markup: {
    inline_keyboard: [
      [
        { text: '💬 WhatsApp', url: 'https://whatsapp.com/channel/0029Vb6Og0a77qVTP5tv5E1f' }
      ],
      [
        { 
          text: '📢 Channel 1', 
...
function handleReport(bot, ADMIN_IDS) {
    bot.onText(/\/report (.+)/, async (msg, match) => {
        ...
        // ✅ Confirm to user
        await bot.sendMessage(chatId, "✅ Your report has been submitted successfully. The Empire team will work in it soon thanks for the cooperation.");
